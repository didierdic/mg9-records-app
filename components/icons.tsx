...
export const PlayAllIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
...
export const RegenerateIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
      <path fillRule="evenodd" d="M15.312 11.424a5.5 5.5 0 01-9.201 2.466l-.312-.311h2.433a.75.75 0 000-1.5H3.989a.75.75 0 00-.75.75v4.242a.75.75 0 001.5 0v-2.43l.31.31a7 7 0 0011.667-3.283.75.75 0 00-.578-1.357zM4.688 8.576a5.5 5.5 0 019.201-2.466l.312.311H11.76a.75.75 0 000 1.5h4.242a.75.75 0 00.75-.75V3.03a.75.75 0 00-1.5 0v2.43l-.31-.31a7 7 0 00-11.667 3.283.75.75 0 00.578 1.357z" clipRule="evenodd" />
    </svg>
);

export const CopyIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
        <path d="M7 3.5A1.5 1.5 0 018.5 2h3.879a1.5 1.5 0 011.06.44l3.122 3.12A1.5 1.5 0 0117 6.622V12.5a1.5 1.5 0 01-1.5 1.5h-1v-3.379a3 3 0 00-3-3H8.5a1.5 1.5 0 01-1.5-1.5v-1z" />
        <path d="M3 8.5A1.5 1.5 0 014.5 7h5A1.5 1.5 0 0111 8.5v7A1.5 1.5 0 019.5 17h-5A1.5 1.5 0 013 15.5v-7z" />
    </svg>
);
