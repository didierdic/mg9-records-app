...
export const metadata: Metadata = {
  title: "mg9 records | Mixing, Mastering & Music Tools",
  description: "mg9 records offers professional mixing, mastering, and AI-powered music creation tools. Elevate your sound with our expert services and innovative applications.",
};
